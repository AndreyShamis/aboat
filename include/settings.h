...
// 🚀 AGGRESSIVE ADAPTATION: Более низкие требования для быстрого повышения профилей
static constexpr struct {
    float minRssi;
    float minSnr;       // Добавляем SNR для более точного определения
    int profileIndex;
} rssiToProfileTable[] = {
    // GFSK профили для отличного сигнала (очень агрессивные пороги)
    { -75.0f, 10.0f, 12 }, // 🚀 Максимальная скорость GFSK (еще более низкий порог)
    { -80.0f,  8.0f, 11 }, // GFSK быстрый (агрессивный порог)
    { -85.0f,  6.0f, 10 }, // GFSK средний (агрессивный порог)
    { -90.0f,  4.0f,  9 }, // GFSK консервативный (агрессивный порог)
    
    // LoRa профили для стандартных условий (очень агрессивные пороги)
    { -95.0f,  2.0f,  8 }, // LoRa максимальная скорость (очень агрессивно)
    { -100.0f, 0.0f,  7 }, // LoRa очень быстрый (очень агрессивно)
    { -105.0f, -2.0f, 6 }, // LoRa скорость + дальность (очень агрессивно)
    { -110.0f, -4.0f, 5 }, // LoRa быстро при хорошем сигнале (очень агрессивно)
    { -114.0f, -6.0f, 4 }, // LoRa средний, открытая местность (очень агрессивно)
    { -116.0f, -8.0f, 3 }, // LoRa средний режим (очень агрессивно)
    { -118.0f, -10.0f, 2 }, // LoRa надёжный компромисс (очень агрессивно)
    { -119.0f, -12.0f, 1}, // LoRa очень хорошая устойчивость (очень агрессивно)
